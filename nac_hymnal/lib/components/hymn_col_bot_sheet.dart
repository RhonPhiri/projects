...
import 'package:nac_hymnal/components/create_hymn_collection_alert_dialog.dart';
import 'package:nac_hymnal/components/modal_bot_sheet_container.dart';
import 'package:nac_hymnal/models/models.dart';
import 'package:nac_hymnal/providers/providers.dart';
      ...
      child: Text.rich(
        ...
        TextSpan(
          ...
          children: [
            ...
            TextSpan(text: ' to add a new collection'),
          ],
        ),
